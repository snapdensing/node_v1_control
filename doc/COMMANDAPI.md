...
Python functions for configuring and controlling RESE2NSE v1 nodes (XBee). Code can be found in [command_api.py](https://github.com/snapdensing/node_v1_control/blob/v1.2/command_api.py).
